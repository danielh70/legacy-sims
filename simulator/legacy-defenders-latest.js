...
// Backwards-compat alias (older naming).
// We keep the old key as a *non-enumerable* alias so it doesn't inflate defender counts
// when scripts iterate Object.keys().
