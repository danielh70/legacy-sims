(async () => {
  LegacyTruthCollector.debugHandles();
  return await LegacyTruthCollector.runLegacyExport({
  "meta": {
    "sourceSimFile": "legacy-sim-v1.0.4-clean.js",
    "attackerSource": "manual-export",
    "attackerLabel": "CUSTOM_MAUL_A4_DL_ABYSS",
    "attackerAttackType": "normal",
    "crystalSlots": 4
  },
  "attackers": [
    {
      "name": "CUSTOM_MAUL_A4_DL_ABYSS",
      "build": {
        "stats": {
          "level": 80,
          "hp": 650,
  ...
  "defenders": [
    ...
    },
    {
      ...
      "build": {
        ...
        "misc1": {
          "name": "Bio Spinal Enhancer",
          "crystal": "Perfect Yellow Crystal",
          "upgrades": []
        },
        "misc2": {
          "name": "Scout Drones",
  ...
  "outputFile": "legacy-truth-v4-custom-maul-a4-dl-abyss-full15.json"
});
})();
