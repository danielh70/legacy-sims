...
function attemptWeapon(
  ...
  const runtimeBioLaneGate =
    ...
    def.__meta.m1.crystalName === 'Perfect Pink Crystal' &&
    def.__meta.m2.crystalName === 'Perfect Pink Crystal' &&
    def.w1 &&
    def.w2 &&
    (def.w1.name === 'Rift Gun' || def.w1.name === 'Core Staff') &&
    (def.w2.name === 'Rift Gun' || def.w2.name === 'Core Staff');
