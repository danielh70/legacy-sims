...
def load_debug(path: Path):
    ...
    return {
        ...
        "attacker": {
            ...
            "splitActionCount": a["splitActionCount"],
            "splitActionKilledAfterW1Count": a["splitActionKilledAfterW1Count"],
            "splitActionReachedW2Count": a["splitActionReachedW2Count"],
        ...
        "defender": {
            ...
            "splitActionCount": d["splitActionCount"],
            "splitActionKilledAfterW1Count": d["splitActionKilledAfterW1Count"],
            "splitActionReachedW2Count": d["splitActionReachedW2Count"],
...
def main():
    if len(sys.argv) != 9:
        raise SystemExit(
            "usage: parse_split_action_diag.py caseA caseB caseC caseD caseE debugA debugB debugC"
        )
    cases = {
